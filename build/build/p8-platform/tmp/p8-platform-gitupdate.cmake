...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/manual/kodi/pvr.iptvsimple/build/build/p8-platform/src/p8-platform/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/root/manual/kodi/pvr.iptvsimple/build/build/p8-platform/src/p8-platform/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
